...
namespace ApiGamesCatalog.Repositories
{
    public class GameRepository : IGameRepository
    {
        ...
        public Task<List<Game>> GetGameByNameAndPublisher(string name, string publisher)
        {
            return Task.FromResult(games.Values.Where(jogo => jogo.Name.Equals(name) && jogo.Publisher.Equals(publisher)).ToList());
        }
